...
public class AgendaActivity extends AppCompatActivity {
    ...
    private View.OnClickListener clickNewReserve = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            /*dialogNewReserve.onDismiss(new DialogInterface() {
                @Override
                public void cancel() {
    ...
    private View.OnClickListener clickFiltrar = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            new DialogFragment() {
                ...
                private RadioGroup.OnCheckedChangeListener checkedChangeListenerPeriodos = new RadioGroup.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                private View.OnClickListener clickDateEnd = new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        class DatePickerFragment extends DialogFragment
                                implements DatePickerDialog.OnDateSetListener {
